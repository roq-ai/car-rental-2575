  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Empowering Seamless Car Sharing Experiences with Car Rental - Manage Profiles, Book Vehicles, Track Usage and Assess Performance, All in One Central Hub."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Empowering Seamless Car Sharing Experiences with Car Rental - Manage Profiles, Book Vehicles, Track Usage and Assess Performance, All in One Central Hub.`}
            </Text>
            <Box
